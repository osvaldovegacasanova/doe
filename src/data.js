...
export const myBio = `Potenciamos tu marca, aceleramos tu crecimiento.`;

// about me text for about section

export const aboutMe =
  'Cada marca tiene sus propios desafíos. Más de 15 años evolucionando en marketing y decisiones basadas en datos nos permiten generar estrategias robustas y con sentido para cumplir los objetivos de tu organización, negocio o emprendimiento.';
